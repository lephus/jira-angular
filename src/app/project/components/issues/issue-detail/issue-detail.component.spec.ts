import { IssueDetailComponent } from '@app/project/components/issues/issue-detail/issue-detail.component';
import { IssuePriority, IssueStatus, IssueType } from '@app/interface/issue';
