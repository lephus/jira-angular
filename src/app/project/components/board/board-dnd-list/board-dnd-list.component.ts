...
import { IssueStatus, IssueStatusDisplay, JIssue } from '@app/interface/issue';
import { FilterState } from '@app/project/state/filter/filter.store';
import { ProjectService } from '@app/project/state/project/project.service';
import { Observable, combineLatest } from 'rxjs';
import { untilDestroyed, UntilDestroy } from '@ngneat/until-destroy';
import { FilterQuery } from '@app/project/state/filter/filter.query';
